...
requirements = python3==3.9.18,hostpython3==3.9.18,kivy==2.1.0,pillow==9.5.0,requests,flask==2.0.0,xlsxwriter,statistics,kivy_garden,werkzeug==2.2.2,matplotlib
