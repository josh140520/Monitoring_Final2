        ...
        with self.ids.temp_layout.canvas:
            ...
            for y in line_listY:
                if y is not None:
                    ...
                    line_position_x = self.ids.temp_layout.x + position_offset[0] + self.ids.temp_layout.width * (1 / max(listX)) * (0.5) +40 #bago
                    line_position_y = (self.ids.temp_layout.y + position_offset[1] +
                                       self.ids.temp_layout.height * (y / max(line_listY)) * 0.7) + 15 #bago
